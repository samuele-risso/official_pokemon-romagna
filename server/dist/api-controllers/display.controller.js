...
const display_commands_js_1 = require("../api-commands/display.commands.js");
const base_controllers_js_1 = require("../api-base/base.controllers.js");
class DisplayController extends base_controllers_js_1.BaseControllers {
    ...
    async Add(req, res) {
        const istance = new display_commands_js_1.DisplayCommands();
        const payload = {
            img: req.body.img,
        ...
        try {
            ...
            res.status(201).json({ message: 'Display added successfully.' });
        }
        catch (error) {
