...
const collections_commands_js_1 = require("../api-commands/collections.commands.js");
const base_controllers_js_1 = require("../api-base/base.controllers.js");
class CollectionsController extends base_controllers_js_1.BaseControllers {
    ...
    async Add(req, res) {
        const istance = new collections_commands_js_1.CollectionsCommands();
        const payload = {
            img: req.body.img,
